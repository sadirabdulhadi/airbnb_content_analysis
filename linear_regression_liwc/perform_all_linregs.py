...
def clean_dataframe(census, reviews, year):
    ...
    sf.drop(["nonenglish_household", "household_size", "educated", "deprivation", "distance_to_center"], axis=1, inplace = True)
...
def perform_linreg(table_reviews, table_census, final_saving_table, metric):
...
for dictionary in dictionaries:
    for prop_type in types:
        for metric in metrics[dictionary]:
            ...
            final_saving_file = "/Users/Sadir/Documents/Computer_science/Year4/term2/individual_project/results/london/total-linreg/raw_val/"+dictionary + "/" + prop_type + "/" + metric + ".csv"
