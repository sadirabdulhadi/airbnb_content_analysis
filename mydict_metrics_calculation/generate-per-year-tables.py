...
indices = ["prof", "loc", "prop", "soc", "soc_rel"]
indices_bis = ["prof", "loc", "prop", "soc", "soc_rel"]



download_dir = "/Users/Sadir/Documents/Computer_science/Year4/term2/individual_project/results/" + city + "/table-reviews-info-mydict.csv" #manchester/bristol
results_dir = "/Users/Sadir/Documents/Computer_science/Year4/term2/individual_project/results/" + city + "/dictionary-results/mydict/private/private"
...
def fillList():
    ...
    with open(download_dir) as csv_file:
        ...
        for row in csv_reader:
            if row["Listingtype"] not in type:
                continue
