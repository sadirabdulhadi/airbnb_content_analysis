...
download_dir = "/Users/Sadir/Documents/Computer_science/Year4/term2/individual_project/results/"+city+"/linear_regression/mydict/"+property_type+"/"+property_type
...
=======
    ...
    #london
    sf.drop(["household_size", "nonenglish_household", "educated", "deprivation"], axis=1, inplace = True)
...
census = pd.read_csv(table_census)
reviews = pd.read_csv(table_reviews + pref +"prof.csv")
